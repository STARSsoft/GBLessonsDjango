...
1. Создай отдельную ветку контроля версий.
2. Создай файл calculator.py
3. Напиши в этом файле программу "Калкулятор" для выполнения простых арифметических действий (+ , - , * , / )
